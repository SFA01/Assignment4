...
namespace Assignment4.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CompanyLocation,Owner")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CompanyLocation,Owner")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
